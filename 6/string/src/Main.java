...
public class Main {
    ...
    public static void main(String[] args) {
        String text = "Мой исходный текст здесь заесь. Замените его на реальный текст.";

       System.out.println("\n-------\n"+"Task " + n++);
       Task1("привет пока мир. мир. мир мир 1 2 3 4");

        System.out.println("\n-------\n"+"Task " + n++);
        Task2(text+" Два слова. Однослова.");

        System.out.println("\n-------\n"+"Task " + n++);
        Task3("привет всем. пока всем никита. зачем так делать.");

        System.out.println("\n-------\n"+"Task " + n++);
        Task4(text+" Кто съел суп? Никита НИКТО.", 3);
    ...
    //Предложение с максимальным кол-вом уникальных слов
